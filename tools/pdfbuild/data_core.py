...
TODO = [
 ...
 ("✅ 已訂","Schuchmann 酒浴 SPA 1/10 18:00–19:00","已訂","355 GEL/90分","同酒莊講晚餐 19:30 開"),
 ...
 ("✅ 已訂","Jiwan @ NMoQ 27/9 13:00 · 2 位","已訂","QAR 100 set","米芝蓮必比登"),
 ("🟡 3–4週","Dolmama（8/10 Yerevan）","dolmamarestaurant.com","25–40k AMD","要庭院位"),
 ("✅ 已訂","Maisi 29/9 19:30 · Palaty 2/10 19:30","已訂","—","Barbarestan 9/10 亦已訂"),
 ("🟢 1–2週","Lavash（7/10 Yerevan）","+374 10 608800","12–20k AMD","平日 1 日前夠"),
...
BOOK_NOW = [
 ...
 ("🔴","🏜 沙漠內海日出團（27/9 日，或改 28/9 朝）","27/9 03:45–09:00","首選 **Qatar Inbound Tours「Sunrise at the Desert」**inboundtoursqatar.com · ☎/WhatsApp +974 7734 1200（私人團 04:30–08:30，**明文可接 Doha 以外，收附加費**，TripAdvisor 1,039 個 5.0）· 彈性：GetYourGuide「Sunrise Desert Safari with Dune Bashing and Inland Sea」#433893（Adventure Time，24 小時前免費取消、先訂後付）· 升級：Discover Qatar「Sunrise in the Desert」03:30–09:30 包 Outpost 五星營早餐 ☎+974 4144 5150","QIT QAR 275/人 · GYG US$58/人 · 365 Adventures 2 人 QAR 450/人 · Discover Qatar 網頁 QAR 320（每人／每車未清楚）","⚠️訂單要寫明接客點 Souq Al Wakra Hotel（Al Wakrah）同時間 — 除 QIT 外官網只寫 Doha 市內接送 · 訂私人 2 人團唔好拼團 · 唔使要求 NMoQ 落客，返酒店沖涼再出去 · Gulf Adventures 官網 404，唔好用"),
...
BOOK_LATER = [
 ...
 ("✅","Jiwan @ NMoQ","27/9 日 13:00 · 2 位","WhatsApp +974 7102 7750 · jiwan.qa","set lunch QAR 100","✅已訂 · 米芝蓮必比登 · 想要露台位可以再 message"),
