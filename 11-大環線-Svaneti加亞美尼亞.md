...
```mermaid
flowchart LR
    A[第比利斯 D1] --> B[Kazbegi D2-3] --> C[Kutaisi D4] --> D[Mestia D5]
    D --> E[Ushguli D6] --> F[Zagari→Kutaisi D7] --> G[Akhaltsikhe D8]
    G --> H["🛂Bavra→Gyumri D9"] --> I[Yerevan D10] --> J[Garni/Geghard D11]
    J --> K["🛂Debed→第比利斯 D12"] --> L[還車 D13] --> M[✈️ D14]
```
